# BIOMD0000000442: MODEL1112190005
...
`pip install git+https://github.com/biomodels/BIOMD0000000442.git`

To install a specific version (in this example, from the 2014-09-16 BioModels release)

`pip install git+https://github.com/biomodels/BIOMD0000000442.git@20140916`

## Usage

Importing the model package.

`import BIOMD0000000442 as model`
...
Sarma2012 - Oscillations in MAPK cascade (S2), inclusion of external
signalling module
...
to model S2 that comprises negative feedback from MK-PP to MKKK-P layer
coupled to positive feedback from MK-PP to MKK-PP layer. In addition, a
positive feedback loop from S2 to the phosphorylation step of Kinase X has
been introduced.
...
and identified by:
[MODEL1112190005](http://identifiers.org/biomodels.db/MODEL1112190005) .
